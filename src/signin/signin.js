    ...
    return (
        <div className="signin-container" >
            <div className="signin-inner" data-aos="zoom-in">
                <Link style={{ color: 'inherit', textDecoration: 'inherit'}} to="/"><p className="companyNameSignIn"><img src="images/logo.png" className="logoLogin"></img><p className="companyName">SteinbergSecurity</p></p></Link>
