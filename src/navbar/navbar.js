        ...
        <div className="nav-container">
            ...
            <ul className="nav-left">
                <Link style={{ color: 'inherit', textDecoration: 'inherit'}} to="/"><li className="companyLogo" onClick={()=>{window.scrollTo(0, 0)}}> StenbergSecurity</li></Link>
                 <Link style={{ color: 'inherit', textDecoration: 'inherit'}} to="/products"><li className="productsBtn" onClick={()=>{window.scrollTo(0, 0)}}>Products<img className="caretDown" src="images/caretDown.png"></img></li></Link>
