   ...
   <div className="homepage2">
       <div className="homepage2-inner">
            <div className='homepage-left2'>
                ...
                Seamlessly integrate multiple device types and platforms into your 1:1 deployment. From Chromebooks and Apple devices to Windows and BYOD, StenbergSecurity's suite of tools can help keep your students safe on any device.
                </p>
            </div>
