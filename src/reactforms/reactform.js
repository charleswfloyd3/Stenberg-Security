...
<form onSubmit={handleSubmit(onSubmit)} className="signupform">
    ...
    <input type="text" name="fname" className="fnameInput" {...register("firstName")} required></input>
    ...
    <input type="email" name="email2" className="emailInput2" {...register("email")} required></input>
    <p className="jobTitle">Are you representing yourself or an organization?</p>
    <select type="text" name="personProtected" placeholder="" className="jobInput" {...register("representation")} required>
    ...
    <input type="tel" name="number" className="phoneNumInput" placeholder="" {...register("phoneNumber")} required></input>
    ...
    <input type="number" min="1" name="devices" className="devicesInput" {...register("devices")} required></input>
